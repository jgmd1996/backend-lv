...
## Functionalities;
 create delete read and update the famous crud
## How users can use it;
using the terminal npm install then go to the mongo db initially create a pistaster and add it to app.js once that is done it will work
## Where users can find help about their project;
alura course at https://cursos.alura.com.br/course/nodejs-api-rest-express-mongodb
## Authors of the project.

Joao Gabriel Moreira Doudemnt
with the help of jonathan rick moreira doudement.
